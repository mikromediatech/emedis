<?= $this->include('Theme/modern/partials/main') ?>
    ...
    <head>
        ...
        <?php echo view('Theme/modern/partials/title-meta', array('title' => 'Sign In')); ?>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" action="<?= base_url('register') ?>" method="post" >
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="confirm-password-input"> Ulangi Password</label>
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5 password-input" id="confirm-password-input" onpaste="return false" name="confirm-password"  placeholder="Enter password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button"  ><i class="ri-eye-fill align-middle"></i></button>
                                                <div class="invalid-feedback">
